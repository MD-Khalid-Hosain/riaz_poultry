        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Update PC Component</strong></h2>
                        </div>
                        <div class="body">
                             @if (session('error'))
                            ...
                            <div class="alert alert-success alert-dismissible" >
                             ...
                             @endif
                            <form action="{{ route('update.component') }}" method="POST" >
                                @csrf
                                <div class="form-row">
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <label for="component_name">PC Component</label><span class="required">*</span>
                                        <div class="form-group">
                                            <input type="text" id="component_name"  name="component_name" class="form-control" value="{{ $pcComponent->component_name }}">
                                            <input type="hidden" name="component_id" value="{{ $pcComponent->id }}">
