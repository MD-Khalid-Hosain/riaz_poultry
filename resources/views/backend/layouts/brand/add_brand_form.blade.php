            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form name="brandForm" id="brandForm"action="{{ url('admin/create-brand') }}"   method="POST" enctype="multipart/form-data">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">
                                        <label for="brand_name">Brand Name</label>
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control" id="brand_name" value="{{ old('name') }}" >
                                            @error ('name')
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block waves-effect waves-light">Create Brand</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
