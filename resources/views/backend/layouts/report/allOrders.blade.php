        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2> All Sales of @isset($date) {{ $date }} and Total = {{ number_format($sum)}}Tk  @else @isset($month) {{ $month }}, {{ $year }} and Total = {{ number_format($sum)}}Tk @else @isset($from) {{ $from }} to {{ $to }} and Total = {{ number_format($sum)}}Tk @else Year-{{ $year }} and Total = {{ number_format($sum)}}Tk   @endisset @endisset @endisset</h2>
                    <ul class="breadcrumb">
