                            ...
                            <form name="productForm" id="productForm" action="{{ url('admin/add-productItem-parts') }}"  method="POST">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-12 mt-5">
                                       ...
                                       <div class="itemPartsVariant">
                                            <div class="remove_itemfield">
                                                <div class="row clearfix">
                                                    <div class="col-md-8">
                                                        <input type="text" name="item_parts_variant[]"  class="form-control"/></div>
                                                        <div class="col-md-4"> <button type="button" name="add"  class="btn btn-success add_buttonitemPart">Add More</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
