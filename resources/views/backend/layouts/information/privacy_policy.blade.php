...
active open
@endsection
@section('privacy_active')
    active
@endsection
@section('privacy_toggled')
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Privacy Information</strong></h2>
                            <i class="fas fa-toggle-on"></i>
                        </div>
                        <div class="body">
                            <form name="sectionForm" id="sectionForm" @if ($count < 1) action="{{ route('privacy-create') }}" @else action="{{ route('privacy-about') }}" @endif method="POST">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">

                                        <label for="description">Privacy Information</label>
                                        <div class="form-group">
                                                <textarea name="privacy_information"  class="form-control summernote"  rows="9"> @if(!empty($privacy->privacy_information)) {{ $privacy->privacy_information }} @endif </textarea>
                                        ...
                                        <div class="form-group" style="text-align:center">
                                           <input type="text" name="meta_title"  class="form-control" id="meta_title" @if(!empty($privacy->meta_title)) value="{{ $privacy->meta_title }}"  @endif>
                                            @error ('meta_title')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <textarea name="meta_description" class="form-control" id="meta_description"  rows="6">@if(!empty($privacy->meta_description)) {{ $privacy->meta_description }} @endif</textarea>
                                        </div>
