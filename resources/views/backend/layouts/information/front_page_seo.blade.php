...
active open
@endsection
@section('front_page_active')
    active
@endsection
@section('front_page_toggled')
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>Front Page SEO</strong></h2>
                            <i class="fas fa-toggle-on"></i>
                        </div>

                        <div class="body">
                            <form name="sectionForm" id="sectionForm" @if ($count < 1) action="{{ route('front-page-seo-create') }}" @else action="{{ route('update-front-page') }}" @endif method="POST">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">

                                        <label for="description">Front Page SEO</label>

                                        <div class="form-group">
                                                <textarea name="description"  class="form-control summernote"  rows="9">@if(!empty($frontPage->description)) {{ $frontPage->description }} @endif</textarea>
                                            @error ('description')
                                        ...
                                        <div class="form-group" style="text-align:center">
                                           <input type="text" name="meta_title"  class="form-control" id="meta_title" @if(!empty($frontPage->meta_title)) value="{{ $frontPage->meta_title }}"  @endif>
                                            @error ('meta_title')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <textarea name="meta_description" class="form-control" id="meta_description"  rows="6">@if(!empty($frontPage->meta_description)) {{ $frontPage->meta_description }} @endif</textarea>
                                        </div>
