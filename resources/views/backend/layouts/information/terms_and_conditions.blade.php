...
active open
@endsection
@section('terms_active')
    active
@endsection
@section('terms_toggled')
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form name="sectionForm" id="sectionForm" @if ($count < 1) action="{{ route('terms-create') }}" @else action="{{ route('update-terms') }}" @endif method="POST">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">
                                        ...
                                        <div class="form-group">
                                                <textarea name="terms_description"  class="form-control summernote"  rows="9"> @if(!empty($terms->terms_description)) {{ $terms->terms_description }} @endif </textarea>
                                        ...
                                        <div class="form-group" style="text-align:center">
                                           <input type="text" name="meta_title"  class="form-control" id="meta_title" @if(!empty($terms->meta_title)) value="{{ $terms->meta_title }}"  @endif>
                                            @error ('meta_title')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <textarea name="meta_description" class="form-control" id="meta_description"  rows="6">@if(!empty($terms->meta_description)) {{ $terms->meta_description }} @endif</textarea>
                                        </div>
