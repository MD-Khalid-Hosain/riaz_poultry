...
active open
@endsection
@section('delivery_active')
    active
@endsection
@section('delivery_toggled')
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form name="sectionForm" id="sectionForm" @if ($count < 1) action="{{ route('delivery-policy-create') }}" @else action="{{ route('delivery-policy-update') }}" @endif method="POST">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">

                                        <label for="deliveryPolicy">Delivery Policy</label>
                                        <div class="form-group">
                                                <textarea name="delivery_policy"  class="form-control summernote"  rows="9"> @if(!empty($deliveryPolicy->delivery_policy)) {{ $deliveryPolicy->delivery_policy }} @endif </textarea>
                                        ...
                                        <div class="form-group" style="text-align:center">
                                           <input type="text" name="meta_title"  class="form-control" id="meta_title" @if(!empty($deliveryPolicy->meta_title)) value="{{ $deliveryPolicy->meta_title }}"  @endif>
                                            @error ('meta_title')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <textarea name="meta_description" class="form-control" id="meta_description"  rows="6">@if(!empty($deliveryPolicy->meta_description)) {{ $deliveryPolicy->meta_description }} @endif</textarea>
                                        </div>
