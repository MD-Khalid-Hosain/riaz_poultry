        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong>About Information</strong></h2>
                            <i class="fas fa-toggle-on"></i>
                        </div>
                        <div class="body">
                            <form name="sectionForm" id="sectionForm" @if ($count < 1) action="{{ route('about-create') }}" @else action="{{ route('update-about') }}" @endif method="POST">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">

                                        <label for="description">About Information</label>
                                        <div class="form-group">
                                                <textarea name="about_description"  class="form-control summernote"  rows="9"> @if(!empty($about->about_description)) {{ $about->about_description }} @endif </textarea>
                                            @error ('about')
                                        ...
                                        <div class="form-group" style="text-align:center">
                                           <input type="text" name="meta_title"  class="form-control" id="meta_title" @if(!empty($about->meta_title)) value="{{ $about->meta_title }}"  @endif >
                                         </div>

                                        <label for="meta_description">Meta Description</label>
                                        <div class="form-group">
                                            <textarea name="meta_description" class="form-control" id="meta_description"  rows="6">@if(!empty($about->meta_description)) {{ $about->meta_description }} @endif </textarea>
                                        </div>
