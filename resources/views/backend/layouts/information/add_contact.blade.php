...
@section('contact_settings_active')
active open
@endsection
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form name="contactForm" id="contactForm"  action="{{ route('contact-create') }}" method="POST">
                            @csrf
                                <div class="row clearfix ">
                                    <div class="col-md-6 m-auto">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="location_map" class="form-control" id="location_map"value="{{ old('location_map') }}" >
                                            @error ('location_map')
                                             <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                                <textarea name="address"  class="form-control summernote"  rows="9">{{ old('address') }}</textarea>
                                            @error ('address')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="close_day" class="form-control" id="close_day"  value="{{ old('close_day') }}" >
                                            @error ('close_day')
                                             <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
